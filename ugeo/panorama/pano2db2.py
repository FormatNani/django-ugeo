...
if __name__ == "__main__":
    ...
    # import freepanos
    lons = [12971348, 12971363, 12971381, 12971400, 12971408, 12971487, 12971512, 12971498, 12971487]
    lats = [4834064, 4834024, 4834035, 4834086, 4834090, 4834150, 4834119, 4834131, 4834086]
