...
class Layer:
    ...
    """
    def __init__(self, config, projection, metatile, stale_lock_timeout=15, cache_lifespan=None, write_cache=True, allowed_origin=None, max_cache_age=None, redirects=None, preview_lat=0, preview_lon=0, preview_zoom=10, preview_ext='png', bounds=None, tile_height=256):
        self.provider = None
        self.config = config
...
<html>
<head>
    <title>PreView: %(layername)s</title>
...
<body>
    ...
    <!--
        var template = '/v1/vectortile/%(layername)s/{Z}/{X}/{Y}.%(ext)s';
